...
async def send_support_message(
    ...
    try:
        ...
        logger.warning("kai.support.not_configured user_id=%s", payload.user_id, exc_info=True)
        raise HTTPException(
            status_code=status.HTTP_503_SERVICE_UNAVAILABLE,
            detail={
                "code": "SUPPORT_EMAIL_NOT_CONFIGURED",
                "message": "Support messaging is not available. Please contact us another way.",
            },
        ) from exc
        ...
        raise HTTPException(
            ...
            detail={
                ...
                "message": "Support message could not be delivered. Please try again later.",
            },
        ) from exc
